...
import (
	...
	"github.com/crossplane/provider-openstack/apis"
	"github.com/crossplane/provider-openstack/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-openstack"))
	if *debug {
	...
	kingpin.FatalIfError(controller.Setup(mgr, log, rl), "Cannot setup OpenStack controllers")
